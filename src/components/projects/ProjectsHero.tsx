    ...
    return (
        <section className="hero-section relative min-h-[50vh] flex items-center pt-24 pb-12 overflow-hidden bg-slate-50 dark:bg-slate-950 border-b border-slate-200 dark:border-slate-800">
            ...
            <motion.div
                ...
                className="absolute -top-32 -right-32 w-[550px] h-[550px] bg-gradient-to-bl from-primary/30 to-indigo-500/25 rounded-full blur-[110px] z-0"
            />
            <motion.div
                animate={{
                    x: [0, -70, 0],
                ...
                className="absolute -bottom-24 -left-24 w-96 h-96 bg-gradient-to-tr from-indigo-500/30 to-purple-500/20 rounded-full blur-[80px] z-0"
            />
            <motion.div
                animate={{
                    scale: [1, 1.7, 1],
                ...
                className="absolute top-1/2 right-1/2 w-64 h-64 bg-gradient-to-tl from-purple-500/25 to-primary/25 rounded-full blur-[100px] z-0"
            />
            ...
            <div className="container mx-auto px-6 md:px-12 max-w-7xl relative z-10">
                <div className="grid lg:grid-cols-2 gap-10 items-center">
                    ...
                    <motion.div
                        ...
                        className="space-y-4"
                    >
                        <div className="inline-flex items-center rounded-full border border-primary/20 bg-primary/5 px-3 py-1.5 text-xs font-medium text-primary">
